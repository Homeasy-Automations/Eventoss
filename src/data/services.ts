...
export const pillars: Pillar[] = [
  ...
  {
    slug: "mice-conferences",
    number: "03",
    title: "Conferences, Conventions & MICE",
    tagline: "End-to-end planning and execution for business travel and large-scale gatherings.",
    description: "Our MICE team manages the full arc of business travel and delegate experience — from incentive programmes to international conferences and destination events.",
    subservices: [
      "Conferences", "Conventions", "Seminars", "Business Summits", "MICE Programs",
      "Incentive Travel", "Corporate Travel", "Dealer / Partner Conferences",
      "International Conferences", "Destination Events", "Hospitality & Guest Management",
      "Delegate Management",
    ],
