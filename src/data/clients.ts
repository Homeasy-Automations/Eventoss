...
export const clientRoster: ClientEntry[] = [
  { slug: "elegano-launch", client: "Elegano", description: "Organized the launch of Elegano, International Watch Studio at Jagat Trade Centre along with media mobilization.", category: "Events & Entertainment" ,logo: "/work1.png" },
  ...
  { slug: "ola-delhi-mela", client: "OLA", description: "Managed the activity for OLA at Delhi NCR during OLA's launch of Auto Driver Partner Mela across India.", category: "Marketing & Advertising" ,logo: "/logos/OLA.png" },
  ...
  { slug: "senco-diamond-launch", client: "Senco", description: "Planned and executed the launch of its Forever Diamond Collection at Ranchi.", category: "Events & Entertainment" , logo: "/logos/vespa.png" },
  ...
  { slug: "ge-transportation-wild-west", client: "GE", description: "Executed the Family Day celebration for GE Transportation on a Wild West theme.", category: "Events & Entertainment" , logo: "/logos/GE2.png" },
  ...
  { slug: "sds-ramcides-recognition", client: "SDS", description: "SDS Ramcides continued to put its trust in Eventoss for their Annual Reward and Recognition Ceremony.", category: "Events & Entertainment" , logo: "/logos/SDS.png" },
  ...
  { slug: "aircel-milestone", client: "Aircel", description: "Executed the milestone achievement celebration at the Aircel office.", category: "Events & Entertainment" , logo: "/logos/AIRCEL.png" },
  { slug: "idea-army-theme-meet", client: "Idea", description: "Organized the All Team Meet based on an Army theme at Ranchi, Begusarai and Muzaffarpur.", category: "Events & Entertainment" , logo: "/logos/IDEA.png" },
  ...
  { slug: "konark-cement-family-day", client: "Konark Cement", description: "Executed the family day at Mahabodhi, Bodhgaya.", category: "Events & Entertainment" , logo: "/logos/KONARK.png" },
  ...
  { slug: "swacch-sarvekshan-2018", client: "Swacch Sarvekshan", description: "Executed the Swacch Sarvekshan 2018 civic awareness initiative across various locations in Delhi.", category: "Marketing & Advertising" , logo: "/logos/Swacch.png" },
  { slug: "ultratech-btl-jharkhand", client: "Ultratech Cement", description: "Executed BTL promotions for Ultratech Cement across Jharkhand.", category: "Marketing & Advertising" ,logo: "/logos/Ultra.png" },
  ...
  { slug: "blackberry-z3-btl", client: "BlackBerry", description: "Organized the BlackBerry Z3 launch across various Patna outlets through BTL activities.", category: "Marketing & Advertising" , logo: "/logos/blackberry.png"  },
  ...
  { slug: "forks-pins-new-year", client: "Forks & Pins", description: "Organized the New Year celebration at Central Mall.", category: "Events & Entertainment" ,logo: "/logos/forks.png" },
  { slug: "forks-pins-christmas-carnival", client: "Forks & Pins", description: "Organized the Christmas Carnival at Central Mall.", category: "Events & Entertainment" , logo: "/logos/forks.png" },
  ...
  { slug: "nucleus-mall-social-media", client: "Nucleus Mall", description: "Complete social media marketing on Facebook & Instagram with online promotion for the mall's launch.", category: "PR & Digital Marketing" , logo: "/logos/Nucleus.png" },
